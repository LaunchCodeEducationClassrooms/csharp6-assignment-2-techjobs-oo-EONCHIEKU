...
namespace TechJobsOO.Tests
{
    ...
    public class TestTask5
    {
        ...
        {
            //test to verify that TestToStringStartsAndEndsWithNewLine exists
        ...
        public void Test_TestToString_Starts_And_Ends_With_NewLine()
        {
            ...
            //setup
            string text = System.IO.File.ReadAllText("C:\\Users\\LaunchCode\\source\\repos\\csharp6-assignment-2-techjobs-oo-EONCHIEKU\\TechJobsOO.Tests\\StartsAndEndsWithNewLine.txt").ToString();
        ...
        {
            //test to verify that TestToStringHandlesEmptyField exists
            //setup
        ...
        public void Test_TestToStringHandlesEmptyField()
        {
            ...
            string text = System.IO.File.ReadAllText("C:\\Users\\LaunchCode\\source\\repos\\csharp6-assignment-2-techjobs-oo-EONCHIEKU\\TechJobsOO.Tests\\EmptyFieldTest.txt").ToString();
            var stringWriter = new StringWriter();
            Console.SetOut(stringWriter);
            var job = new RunTechJobs();
            job.RunProgram();
